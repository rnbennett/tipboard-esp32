...
// ── JD9165 vendor-specific init (from Guition Arduino reference) ─────
// The minimal Sleep Out + Display On is NOT enough — the JD9165 needs
// power, VCOM, gamma, and timing registers programmed explicitly.
// Without these, the panel shows black even though DSI link is active.
